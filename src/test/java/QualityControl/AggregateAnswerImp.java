...
public class AggregateAnswerImp implements AggregateAnswer{
	    ...
	    */
		 ...
		 /**
			 ...
			 */
		     ...
		     posteriorProb=AggAnswer(topAnswer,wanswer,fillAnswer,finalAnswer,wmlist,similary,priorProb);
		     //����
	 ...
	 * PS���Լ��������ʣ����ñ�Ҷ˹��ʽ���д𰸾ۺϾ���
	 */
	private double[] AggAnswer(String[] topAnswer,String[] wanswer,String[] fillAnswer,String[] finalAnswer,ArrayList<Object> wmlist,double[][] similary,double[] priorProb){
		/**
	      * 
	      * ���ݱ�Ҷ˹��ʽ���д�����
	      * 
		 ...
		 for(int i=0;i<conditionProb.length;i++){
			 ...
			 for(int k=0;k<wanswer.length;k++){
				 ...
				 //2)��ʵ��Ϊѡ�����е�һ�������˻ش�Ĵ�����ʵ�𰸲�ͬ���ҹ��˻ش�Ĵ�Ҳ�������������չ��ѡ����
					 ...
					 conditionProb[i]=conditionProb[i]*(1-Double.parseDouble(wmlist.get(k*2).toString()))*priorProb[i]*(1/(1-priorProb[index]));
					 //����
				 ...
				 //3)��ʵ��Ϊѡ�����е�һ�������ǹ��˻ش�Ĵ������������չ��ѡ����
					...
					//���㹤�˻ش�Ĵ���ĳЩ�˻ش�������Ĵ𰸵����ƶȴ���ĳһ��ֵ
						 ...
						 conditionProb[i]=conditionProb[i]*((1-Double.parseDouble(wmlist.get(k*2).toString()))*(1-sim))*(priorProb[i]/(1-P));
						 //����
				 ...
				 //6)��ʵ�����������չ����ѡ�����һ�������˻ش�Ĵ�������ʵ�𰸲�ͬ���������չ����ѡ�����е�һ��,������ʵ�����ƶ�С��ĳһ��ֵ
					 ...
					 //���㹤�˻ش�Ĵ������лش�������Ĵ𰸵����ƶ�С��ĳһ��ֵ
					 if(f==(fillAnswer.length-1)){
						 conditionProb[i]=conditionProb[i]*(1-Double.parseDouble(wmlist.get(k*2).toString()))*(priorProb[i]/(1-priorProb[index])); 
						 //����
				 ...
				 //8)�������Ǵ�Ϊ�������չ��ѡ�����е�һ�������˻ش�Ĵ�����ʵ�𰸲�ͬ�������������չ�Ĵ𰸣��ҹ��˻ش�Ĵ�����ʵ�𰸵����ƶȴ���ĳһ��ֵ
					 ...
					 double sim=Double.parseDouble(wmlist.get(k*2).toString())*similary[i-topAnswer.length][index-topAnswer.length];
					 double dissim=(1-Double.parseDouble(wmlist.get(k*2).toString()))*(1-similary[i-topAnswer.length][index-topAnswer.length]);
	...
	private  void setThreshold(float threshold) {
		...
		AggregateAnswerImp.threshold = threshold;
