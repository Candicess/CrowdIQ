...
public class CDASAggregateAnswerImp implements CDASAggregateAnswer{
	    ...
	    */
		 ...
		 /**
			 ...
			 */
		     ...
		     posteriorProb=AggAnswerCDAS(topAnswer,wanswer,fillAnswer,finalAnswer,wmlist,priorProb);
		     //����
	 ...
	 * ���������ʣ��𰸾ۺϾ���
	 */
	private double[] AggAnswerCDAS(String[] topAnswer,String[] wanswer,String[] fillAnswer,String[] finalAnswer,ArrayList<Object> wmlist,double[] priorProb){
		/**
	      * 
	      * ���ݱ�Ҷ˹��ʽ���д�����
	      * 
	...
	private  void setThreshold(float threshold) {
		...
		CDASAggregateAnswerImp.threshold = threshold;
